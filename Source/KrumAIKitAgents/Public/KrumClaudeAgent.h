...
class KRUMAIKITAGENTS_API FKrumClaudeAgent : public IKrumAgent
{
public:
	FKrumClaudeAgent();
	virtual ~FKrumClaudeAgent() override;
...
private:
	...
	FString ClaudeLineBuffer;
	FString ClaudeAccumulatedResponse;
};
